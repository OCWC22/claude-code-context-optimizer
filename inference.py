"""Fireworks AI Inference (Cost-Optimized).

Multi-provider inference with cost optimization:
- ALL tasks → minimax-m2p1 (cheapest model)
- Optimized for hackathon cost efficiency
- Default: Fireworks AI OpenAI-compatible API

Sponsors: Fireworks AI
Docs:
    - https://docs.fireworks.ai/
    - https://fireworks.ai/models/minimax-m2p1
...
# OPTIMIZED FOR COST - ALWAYS using minimax-m2p1 (cheapest model)
TaskType = Literal["planning", "analysis", "coding", "patching", "cheap", "strong"]

# ALL tasks use minimax-m2p1 for maximum cost optimization
TASK_MODEL_MAP: dict[TaskType, str] = {
    ...
    "strong": "accounts/fireworks/models/minimax-m2p1",           # CHEAPEST - always optimize for cost
}

# Default model - ALWAYS cheapest for cost optimization
